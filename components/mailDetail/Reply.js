...
function Reply({ sender, setReply, body, threadId }) {
  ...
  const onSend = () => {
    ...
    dispatch(addThreadMails({ key: threadId, id: id, sender: loginUser.name }));
    ...
    dispatch(addLoginSent(threadId));
    setContent("");
    setReply(false);
  };
  return (
    <div className="flex items-start truncate">
      ...
      <div className="flex flex-col mx-3 w-11/12 shadow-xl rounded-lg px-6 py-5">
        ...
        <textarea
          className="resize-none h-24 outline-none mt-5"
          value={content}
        ...
        <div className="flex items-center justify-between">
          ...
          <div
            className="text-gray-600 cursor-pointer hover:bg-gray-100 rounded-full px-2 py-2"
